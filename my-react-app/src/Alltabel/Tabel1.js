        ...
        <div className="grid grid-cols-10 gap-3 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-10 xl:grid-cols-10">
          <div className="mt-5 m-2 shadow-40 bg-white border-radius-10 h-auto shadow-xl col-span-2 rounded-lg sm:grid-cols-2">
            <div class="mb-4 px-4 m-3">
              <div
                ...
                class="w-full flex items-center text-blue-400 h-10 pl-4  hover:bg-gray-200 hover:scale-110 duration-300 rounded-lg cursor-pointer"
              >
                <svg
              ...
              <div class="mt-2 w-full flex items-center text-blue-400 h-10 pl-4 bg-gray-200 hover:bg-gray-200  hover:bg-gray-200 hover:scale-110 hover:bg-gray-400 duration-300 rounded-lg cursor-pointer">
                <svg
                  class="h-6 w-6 fill-current mr-2"
                  viewBox="0 0 20 20"
                  fill="none"
              ...
              <div onClick={(e) => Navigate("/Order")} class="mt-2 w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200  hover:bg-gray-200 hover:scale-110 hover:bg-gray-400 duration-300 rounded-lg cursor-pointer">
                <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <div className="mt-5 col-span-6 m-2 rounded-lg sm:grid-cols-8">
            <div class="grid gap-x-8 gap-y-4 grid-cols-5">
              <button
                onClick={(e) => Navigate("/tabel")}
                class=" bg-white px-4 py-2 rounded-md text-sm font-medium hover:scale-110 hover:bg-purple-600 duration-300"
              >
                โต๊ะอาหารทั้งหมด
              </button>
              <button
                onClick={(e) => Navigate("/tabel1")}
                class="bg-purple-500 px-4 py-2 rounded-md text-sm font-medium text-white hover:scale-110 hover:bg-purple-600 duration-300 "
              >
                เพิ่มโต๊ะอาหาร
              </button>
              <button class="bg-white px-4 py-2 rounded-md text-sm font-medium hover:scale-110 hover:bg-white  duration-300">
                เพิ่มเติม...
              </button>
              <button class="bg-white px-4 py-2 rounded-md text-sm font-medium hover:scale-110 hover:bg-white  duration-300">
                เพิ่มเติม...
            ...
            <div className="mt-5 shadow-40 bg-white border-radius-10 h-96 shadow-xl rounded-lg">
              <div class="grid gap-x-2 gap-y-10 grid-cols-4 px-5 ml-2 ">
                <img
                  src="https://cdn.discordapp.com/attachments/1195436273758912572/1216034859672408085/image-removebg-preview_9.png?ex=65feebb7&is=65ec76b7&hm=c0ad9f25bd732569a8e1aba59c731fa2d13349bccfef6e8af6610d7223b0324b&"
