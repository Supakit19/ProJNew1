        ...
        <div className="grid grid-cols-10 gap-3 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-10 xl:grid-cols-10">
          <div className="mt-5 m-2 shadow-40 bg-white border-radius-10 h-auto shadow-xl col-span-2 rounded-lg sm:grid-cols-2">
            <div class="mb-4 px-4 m-3">
              ...
              <div class="mt-2 w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200  bg-gray-200 hover:bg-gray-200 hover:scale-110 hover:bg-gray-400 duration-300 rounded-lg cursor-pointer">
                <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <div className="mt-5 col-span-6 m-2 rounded-lg sm:grid-cols-8">
            <div class="grid gap-x-8 gap-y-4 grid-cols-5">
              <button class="bg-purple-600 px-4 py-2 rounded-md text-sm font-medium text-white hover:scale-110 hover:bg-purple-600 duration-300">
                คำสั่งซื้อ
              </button>
              <button
            ...
            <div className="mt-5 shadow-40 bg-white border-radius-10 h-96 shadow-xl rounded-lg">
              <div className="py-8 m-3">
                <div className="container mx-auto px-4">
                  <h1 className="text-2xl font-semibold mb-4">NewOrder</h1>
                  <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <table className="w-full">
                          <thead>
                            <tr>
                              ...
                              <th className="text-left font-semibold text-center ">
                                จำนวน
                              </th>
                              <th className="text-left font-semibold text-center">
                                เป็นจำนวนเงิน
                    ...
                    <div className="md:w-1/4">
                      <div className="bg-white rounded-lg shadow-md p-6">
                        ...
                        <button className="bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 w-full hover:scale-110 hover:bg-purple-500 duration-300">
                          รับรายการ
                        </button>
                      </div>
                    </div>
