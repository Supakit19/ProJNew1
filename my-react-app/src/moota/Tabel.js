        ...
        <div className="grid grid-cols-10 gap-3 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-10 xl:grid-cols-10">
          ...
          <div className="mt-5 col-span-6 m-2 rounded-lg sm:grid-cols-8">
            ...
            <div className="mt-5 shadow-40 bg-white border-radius-10 h-96 shadow-xl rounded-lg">
              <div class="grid gap-x-2 gap-y-10 grid-cols-4 px-5 ml-2 p-0">
                <div className="mt-10">
                  ...
                  >
                    <div className="modal-box">
                      <h3 className="font-bold text-lg text-center">โปรดแสกนน!!!!!!!!!!!!!!!!</h3>
                      <img
                        src="https://cdn.discordapp.com/attachments/1195436273758912572/1216365713099587644/ukzBif_qrcode.png?ex=66001fd8&is=65edaad8&hm=7a3b8bf67079415bfc6dde79a256758eb2e4d7a4bf86ac6626332f6194ddbfde&"
                        className="py-4"
                      />
